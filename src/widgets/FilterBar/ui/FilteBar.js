...
export function FilterBar () {
    ...
    const line = <hr width='100%' size='1' className={styles.line}/>
    ...
    return (
        <Stack direction='column' gap='24' className={styles.container}>
            ...
            <Stack direction='column' gap='12'>
                ...
                <Text><input className={styles.radioBrown} type='radio' value='brown' onChange={() => handleChange('color', 'brown')} /> Коричневый</Text>
                <Text><input className={styles.radioGrey} type='radio' value='grey' onChange={() => handleChange('color', 'grey')} /> Серый</Text>
                <Text><input className={styles.radioBlack} type='radio' value='black' onChange={() => handleChange('color', 'black')} /> Черный</Text>
                <Text><input className={styles.radioGreen} type='radio' value='green' onChange={() => handleChange('color', 'green')} /> Зеленый</Text>
                <Text><input className={styles.radioRed} type='radio' value='red' onChange={() => handleChange('color', 'red')} /> Красный</Text>
                <Text><input className={styles.radioOrange} type='radio' value='orange' onChange={() => handleChange('color', 'orange')} /> Оранжевый</Text>
                <Text><input className={styles.radioBlue} type='radio' value='blue' onChange={() => handleChange('color', 'blue')} /> Синий</Text>
                <Text><input className={styles.radioWhite} type='radio' value='white' onChange={() => handleChange('color', 'white')} /> Белый</Text>
            </Stack>
            {line}
            <Stack direction='column' gap='12'>
